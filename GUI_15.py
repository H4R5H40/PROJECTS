...
root=Tk()
def skip():
  global STUDENR_PROFILE,STUDENT_ACCOUNT,ADMIN_ACCOUNT,ID_PASS,BACKGROUND,BACKGROUND1,CHANGE,ATTENDANCE_NAME,DS,ADE,OOP,MATHEMATICS_3,DS_GT
...
def main():
  ...
  Label(root,text='IF YOU ARE RUNING THE FILE FIRST TIME THEN CLICK DOWNLOAD BUTTON\nWAIT UNTIL WIDGET REFRESH\nIF YOU ARE ACCESING IT 2ND TIME OR MORE\nCLICK ON SKIP',font="Georgia 12",foreground="red").place(x=15,y=50)
  Button(text="           DOWNLOAD           ",font="Georgia 12",command=download,background="skyblue",relief='solid').place(x=225,y=150)
  Button(text="           SKIP           ",font="Georgia 12",command=skip,background="skyblue",relief='solid').place(x=250,y=200)
