#ATTEMPT 13 TO CONVERT TERMINAL LOGIC TO GUI
#TRAYING TO SUBJECT WISE ATTENDANCE USING UNIQUE CODE
import pandas as pd
import string
from tkinter import *
import random
...
DS=r"C:\Users\harsh\OneDrive\Desktop\coding\IMAGE OR DATA\DS.csv"
DS_GT=r"C:\Users\harsh\OneDrive\Desktop\coding\IMAGE OR DATA\DS&GT.csv"
ADE=r"C:\Users\harsh\OneDrive\Desktop\coding\IMAGE OR DATA\ADE.csv"
MATHEMATICS_3=r"C:\Users\harsh\OneDrive\Desktop\coding\IMAGE OR DATA\MATHEMATICS 3.csv"
OOP=r"C:\Users\harsh\OneDrive\Desktop\coding\IMAGE OR DATA\OOP.csv"
#====================================================================================================
...
df2= pd.DataFrame(file_name)
a=r"C:\Users\harsh\OneDrive\Desktop\coding\IMAGE OR DATA\Screenshot 2024-11-19 222335.png"
b=PhotoImage(file=a)
#====================================================================================================
  ...
  def send_alert():
    ...
    for j in range(len(alert_no)):
      if i<len(d) and j==int(d[i]) and alert_no[j]!='N.A.':
        k='*'*100
        print(f"{k}\n{alert_no[j][:10]}\n YOUR CHILD IS NOT PRESENT IN THE LECTURE OF TODAY\n")
        #number=alert_no.get()
...
def edit():
  ...
  def change1(i):
      ...
      for widget in root.winfo_children():
        widget.destroy()
      print_info(i)
      Button(root,text="BACK",command=lambda:back(),font="Georgia 12",background="white").place(x=230,y=190)
...
def main():
  ...
  def back():
      pass
  Button(root,text='<-',font="Georgia 12",image=b,command=back,borderwidth=0).place(x=35,y=320)
