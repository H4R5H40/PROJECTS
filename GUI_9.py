#ATTEMPT 9 TO CONVERT TERMINAL LOGIC TO GUI
#TRAYING TO ADD / DELETE STUDENT INFORMATION 
#SEPERATE ID PASS OPTION
import pandas as pd
import string
from tkinter import *
import random
...
ROLL_LIST=r"C:\Users\harsh\OneDrive\Desktop\coding\IMAGE OR DATA\ROLL_LIST_2.csv"
...
info=['Roll No.','Enrollment No.','Name of Student','Student Mo.','Parents Mo.','E-mail','ID','PASSWORD']
#====================================================================================================
def register():
  #👇👇
