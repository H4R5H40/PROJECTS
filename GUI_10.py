#ATTEMPT 10 TO CONVERT TERMINAL LOGIC TO GUI
#TRAYING TO ATTENDANCE
import pandas as pd
import string
from tkinter import *
import random
...
def send_alert():
  alert_no=df[info[4]]
  I=0
  for i in range (len(alert_no)):
    if I<len(n) and i==int(n[I]):
      k='*'*100
      print(f"{k}\n{alert_no[i]}\nYOUR CHILD IS NOT PRESENT IN THE LECCTURE OF {m} TODAY")
      I=I+1
#====================================================================================================
def presenty():
  root.destroy()
